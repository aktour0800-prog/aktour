    ...
    >
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-2 px-3 py-2.5 sm:px-4 sm:py-3">
        <Link to="/" className="text-white">
          ...
          <p className="mt-1 hidden text-[16px] text-white/80 sm:block">프리미엄 알래스카</p>
        </Link>

        <div className="flex shrink-0 items-center gap-2">
          <a
            href={`tel:${contacts[0].tel}`}
            className="inline-flex min-h-[48px] items-center gap-1.5 whitespace-nowrap rounded-xl border border-white/25 px-3 text-[16px] font-semibold text-white"
